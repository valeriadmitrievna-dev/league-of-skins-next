...
const SelectContext = React.createContext<{ variant?: "default" | "primary" }>({
  variant: "default",
});
...
function Select({
  ...
  return (
    <SelectPrimitive.Root data-slot="select" {...props}>
      <SelectContext.Provider value={{ variant }}>{children}</SelectContext.Provider>
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        { 'border-0 pl-4 pr-3 text-foreground!': ctx.variant === 'primary' },
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className={cn(
          ...
          { 'text-foreground!': ctx.variant === 'primary' })}
        />
