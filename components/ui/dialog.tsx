    ...
    <DialogPortal>
      <DialogOverlay onClick={clickHandler}>
        <DialogPrimitive.Content
          ...
          className={cn(
            "bg-background data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 grid max-w-[calc(100%-2rem)] gap-4 rounded-xl p-4 text-sm duration-100 sm:max-w-sm fixed z-50 w-full outline-none shadow-lg/80",
            "relative",
            className,
          )}
          {...props}
