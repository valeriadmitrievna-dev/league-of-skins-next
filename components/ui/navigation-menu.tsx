...
function NavigationMenuLink({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex flex-col gap-1 rounded-sm p-2 py-1.5 text-sm transition-all outline-none hover:bg-secondary data-[active=true]:pointer-events-none data-[active=true]:text-primary [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
        className,
      )}
      {...props}
    />
